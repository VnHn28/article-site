...
$(function() {
    var magz = {
        ...
        adAction:function(){
            ...
            var value1 = window.sessionStorage.getItem("ad_close");
            if(value1) {
                $('#ad_001_m').hide();
            }
            ...
            $("#ad_001_m").find('.close').on('click', function (e) {
                window.sessionStorage.setItem("ad_close", "close_ad_001");
                e.preventDefault();
                $(this).parent().remove();
            });
        },
        ...
        copyright:function () {
            ...
            // console.log($('.copyright span').text(), nowYear)
            $('#copyright span').text(nowYear)
        }
    };
