<?php namespace App\Http\Controllers;
	...
	class AdminTabStoresController extends CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "stores_module";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Ad Schedule End 廣告結束時間","name"=>"ad_schedule_end"];
			...
			$this->form[] = ['label'=>'Ad Position Id 廣告板位','name'=>'ad_position_id','type'=>'select','validation'=>'integer|min:0','width'=>'col-sm-10','datatable'=>'tab_ad_positions,id','datatable_where'=>'ad_position_type=\'stores\'','datatable_format'=>'position_name'];
			$this->form[] = ['label'=>'Ad Schedule Begin 廣告開始時間','name'=>'ad_schedule_begin','type'=>'datetime','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'審閱','name'=>'reviewed','type'=>'select','width'=>'col-sm-9','dataenum'=>'1;0'];
			...
			//$this->form[] = ['label'=>'上架','name'=>'enable','type'=>'number','validation'=>'integer','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'審閱','name'=>'reviewed','type'=>'select','width'=>'col-sm-9','dataenum'=>'1;0'];
			//$this->form[] = ['label'=>'上稿日期','name'=>'created_at','type'=>'datetime','validation'=>'required','width'=>'col-sm-9'];
			# OLD END FORM
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'','url'=>env('APP_URL')."/store/[id]",'icon'=>'fa fa-eye','color'=>'primary'];
