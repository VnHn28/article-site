<?php namespace App\Http\Controllers;
	...
	class AdminTabBooksController extends CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "books_module";
			$this->limit = "20";
			...
			$this->table = "tab_books";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Id","name"=>"id"];
			$this->col[] = ["label"=>"Cover Image 書本照片","name"=>"cover_image","image"=>true];
			$this->col[] = ["label"=>"Title 標題","name"=>"title"];
			$this->col[] = ["label"=>"Recommend Person Author Id 推薦人","name"=>"recommend_person_author_id","join"=>"tab_authors,name"];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'','url'=>env('APP_URL')."/books/[id]",'icon'=>'fa fa-eye','color'=>'primary'];
