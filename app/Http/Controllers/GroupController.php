...
class GroupController extends Controller
{
    ...
    public function show($id){
    	...
    	$related_groups = \App\tab_groups::where('category_id', '=', $group->category_id)->where('tab_groups.enable', '=', 1)->where('tab_groups.reviewed', '=', 1)->limit(3)->orderBy('tab_groups.priority', 'DESC')->orderBy('tab_groups.id', 'DESC')->get();
		return view('group')
