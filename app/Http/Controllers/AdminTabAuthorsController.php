<?php namespace App\Http\Controllers;
	...
	class AdminTabAuthorsController extends CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "authors_module";
			$this->limit = "20";
			...
			$this->table = "tab_authors";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Id","name"=>"id"];
			$this->col[] = ["label"=>"人物名稱","name"=>"name"];
			$this->col[] = ["label"=>"Email","name"=>"email"];
			$this->col[] = ["label"=>"手機號碼","name"=>"phone"];
			$this->col[] = ["label"=>"頭像照片","name"=>"cover_image","image"=>true];
			...
			$this->form[] = ['label'=>'Cover Image 頭像照片','name'=>'cover_image','type'=>'upload','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Id','name'=>'id','type'=>'text','validation'=>'required','width'=>'col-sm-9','placeholder'=>'You can only enter the letter only'];
			//$this->form[] = ['label'=>'Name 姓名','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:70','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Company 公司名稱','name'=>'company','type'=>'ckeditor','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Job Title 職務名稱','name'=>'job_title','type'=>'ckeditor','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Intro 人物介紹','name'=>'intro','type'=>'ckeditor','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Fb Url','name'=>'fb_url','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Cover Image 頭像照片','name'=>'cover_image','type'=>'upload','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Created At 創建日期','name'=>'created_at','type'=>'datetime','width'=>'col-sm-9'];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'','url'=>env('APP_URL')."/writers/[id]",'icon'=>'fa fa-eye','color'=>'primary'];
