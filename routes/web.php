...
Route::get('/', function () {
	...
	$articles = \App\tab_articles::select(['tab_articles.id', 'tab_article_categorys.name as category_name', 'tab_articles.title', 'tab_articles.created_at', 'tab_articles.subtitle', 'tab_articles.cover_image'])
